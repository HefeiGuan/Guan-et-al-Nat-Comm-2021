...
restrict = [];
sd = [];
lowThresholdFactor = 5; %5 Ripple envoloppe must exceed lowThresholdFactor*stdev
highThresholdFactor = 15; %15 10 Ripple peak must exceed highThresholdFactor*stdev
minInterRippleInterval = 50; % 50 in ms
...
% Parameters
windowLength = frequency/1628*1%11;
